...
<div class="row">
    ...
    <div class="well">
        <form method="POST" action="{{ $profileFormAction }}" accept-charset="UTF-8" class="form-horizontal" role="form">
            ...
            <div class="form-group has-info {{ ($errors->has($field)) ? 'has-error' : '' }}" for="{{ $field }}">
            ...
            <div class="form-group">
                <div class="col-sm-offset-2 col-sm-10">
                    <input class="btn btn-info btn-raised" value="Submit Changes" type="submit">
                </div>
            </div>
    ...
    <div class="well">
        <form method="POST" action="{{ route('sentinel.users.memberships', $user->hash) }}" accept-charset="UTF-8" class="form-horizontal" role="form">
            ...
            <div class="form-group">
                <div class="col-sm-offset-2 col-sm-10">
                    <input name="_token" value="{{ csrf_token() }}" type="hidden">
                    <input class="btn btn-info btn-raised" value="Update Memberships" type="submit">
                </div>
            </div>
...
<div class="row">
    ...
    <div class="well">
        <form method="POST" action="{{ $passwordFormAction }}" accept-charset="UTF-8" class="form-inline" role="form">
            ...
            <input name="_token" value="{{ csrf_token() }}" type="hidden">
            <input class="btn btn-info btn-raised" value="Change Password" type="submit">
